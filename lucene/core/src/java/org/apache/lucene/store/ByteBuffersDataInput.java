...
public final class ByteBuffersDataInput extends DataInput
  ...
  private void readGroupVIntDupCode(long[] dst, int offset) throws IOException {
    ...
    dst[offset] = block.getInt(curPosition) & GroupVIntUtil.MASKS[n1Minus1];
    curPosition += 1 + n1Minus1;
    dst[offset + 1] = block.getInt(curPosition) & GroupVIntUtil.MASKS[n2Minus1];
    curPosition += 1 + n2Minus1;
    dst[offset + 2] = block.getInt(curPosition) & GroupVIntUtil.MASKS[n3Minus1];
    curPosition += 1 + n3Minus1;
    dst[offset + 3] = block.getInt(curPosition) & GroupVIntUtil.MASKS[n4Minus1];
