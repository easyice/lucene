...
abstract class MemorySegmentIndexInput extends IndexInput implements RandomAccessInput {
  ...
  private void readGroupVIntDupCode(long[] dst, int offset) throws IOException {
    ...
    try {
      ...
      dst[offset] = curSegment.get(LAYOUT_LE_INT, curPosition) & GroupVIntUtil.MASKS[n1Minus1];
      curPosition += 1 + n1Minus1;
      dst[offset + 1] = curSegment.get(LAYOUT_LE_INT, curPosition) & GroupVIntUtil.MASKS[n2Minus1];
      curPosition += 1 + n2Minus1;
      dst[offset + 2] = curSegment.get(LAYOUT_LE_INT, curPosition) & GroupVIntUtil.MASKS[n3Minus1];
      curPosition += 1 + n3Minus1;
      dst[offset + 3] = curSegment.get(LAYOUT_LE_INT, curPosition) & GroupVIntUtil.MASKS[n4Minus1];
